            ...
            <div class="container">
              <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-12 ftco-animate text-center">
                  <h1 class="mb-2">We serve Fresh makanan &amp; fifteen</h1>
                  <h2 class="subheading mb-4">We deliver organic makanan &amp; fifteen</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{asset('public/images/category-3.jpg')}})">
                            <div class="text px-3 py-1">
                                <h2 class="mb-0"><a href="#">naso goreng</a></h2>
                            </div>      
                        </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Journl</a></li>
